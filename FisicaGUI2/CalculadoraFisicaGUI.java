...
public class CalculadoraFisicaGUI extends JFrame {
    public JTextField tiempoField, distanciaField, velocidadInicialField, aceleracionField, anguloField;
    public JTextArea resultadoArea;
    public JButton calcularButton;
    public JComboBox<String> movimientoComboBox;
    ...
    public CalculadoraFisicaGUI() {
        ...
        calcularButton.setBounds(400, 230, 150, 30);
        add(calcularButton);
